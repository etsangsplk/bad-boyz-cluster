...
\introdef{Infrastructure as a Service (IaaS)}{Offsite infrastructure is provided to a number of end users to securely access and use for their own purposes.}
\end{itemize}
