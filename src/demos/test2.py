...
parser = OptionParser(usage="./test2.py --gh HOSTNAME --gp PORT -t JOB_TYPE -s SCHEDULER")
...
os.system(
	"./client.py --gh %s --gp %s -e test.py -t %s -b 500 testfiles/f3.txt testfiles/f3.txt"
